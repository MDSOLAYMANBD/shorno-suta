...
export default function LandingPage() {
  ...
  const marqueeText = marqueeConfig.text || 'স্বর্ণ সুতায় স্বাগতম • অগ্রিম টাকা লাগে না • পণ্য হাতে পেয়ে দেখে টাকা দিন • ১০০% কোয়ালিটি পণ্য • ৭ দিনের রিটার্ন/এক্সচেঞ্জ • হোম ডেলিভারি সারা বাংলাদেশে • হটলাইন: 01843711211 • হোয়াটসঅ্যাপ: 01843711211';
  ...
  const renderHeader = () => {
    ...
    return (
      <>
        <LandingStickyHeader
          helpline={headerConfig.helpline || settings?.helpline_number || '01843-711211'}
