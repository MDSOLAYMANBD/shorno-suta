...
export const DEFAULT_NAVBAR_CONFIG = {
  ...
  marquee_text: 'স্বর্ণ সুতায় স্বাগতম 🌸 | ❌ অগ্রিম টাকা লাগে না | 📦 পণ্য হাতে পেয়ে দেখে টাকা দিন | 🎯 ১০০% কোয়ালিটি পণ্য | 🔁 ৭ দিনের রিটার্ন/এক্সচেঞ্জ | 🚚 হোম ডেলিভারি সারা বাংলাদেশে | 📞 হটলাইন: 09617356977 | 📲 হোয়াটসঅ্যাপ: 09617356977',
...
export const DEFAULT_INVOICE_CONFIG = {
  ...
  logo_url: '',
  phone: '+8809617-356977',
  whatsapp: '+8809617-356977',
  address: 'Kamrangirchar, Khola Mora Ghat, Dhaka-1211, Bangladesh',
  footer_message: 'প্রিয় গ্রাহক, আলহামদুলিল্লাহ, আপনার অর্ডার পেয়ে আমরা সত্যিই আনন্দিত।\n✅ ভুল বা ক্ষতিগ্রস্ত পণ্য পেলে | 📲 ডেলিভারির ২৪ ঘন্টার মধ্যে ভিডিওসহ WhatsApp করুন: 09617-356977 | 🔄 ৩ দিনের মধ্যে বিনামূল্যে পরিবর্তন করে দেওয়া হবে',
  signature_url: '',
