...
export default function LandingOrderForm({
  ...
  const accent = highlightColor || 'hsl(var(--primary))';
  const priceColor = totalColor || 'hsl(var(--primary))';
      ...
      <div className="max-w-xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-card border border-border rounded-xl p-4 space-y-4">
            ...
            {/* Submit */}
            <Button type="submit" size="lg" className={cn('w-full text-base font-semibold py-6 animate-glow-pulse-btn badge-shimmer', submitRounded ? 'rounded-full' : 'rounded-lg')} style={{ backgroundColor: submitColor || 'hsl(var(--primary))', ...(submitTextColor ? { color: submitTextColor } : {}) }} disabled={loading}>
